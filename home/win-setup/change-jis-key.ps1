...
Write-Host "  変換キー   → F14" -ForegroundColor White
...
try {
  ...
  # 00,00,00,00 - フラグ（常に0）
  # 08,00,00,00 - エントリ数（7つのマッピング + 終了マーカー = 8）
  ...
  # 65,00,79,00 - 変換キー (0x79) を F14 (0x65) にマップ
  ...
  # 00,00,00,00 - 終了マーカー
  $scancodeMap = [byte[]](0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x1d, 0x00, 0x3a, 0x00, 0x3a, 0x00, 0x1d, 0x00, 0x64, 0x00, 0x7b, 0x00, 0x65, 0x00, 0x79, 0x00, 0x64, 0x00, 0x38, 0x00, 0x38, 0x00, 0x5b, 0xe0, 0x65, 0x00, 0x70, 0x00, 0x2b, 0x00, 0x7d, 0x00, 0x29, 0x00, 0x2b, 0x00, 0x00, 0x00, 0x00, 0x00)
